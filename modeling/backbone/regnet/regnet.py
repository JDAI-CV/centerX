...
from ..build import BACKBONE_REGISTRY, get_norm
...
model_urls = {
    '400x': 'https://dl.fbaipublicfiles.com/pycls/dds_baselines/160906036/RegNetX-400MF_dds_8gpu.pyth',
    '400y': 'https://dl.fbaipublicfiles.com/pycls/dds_baselines/160906567/RegNetY-400MF_dds_8gpu.pyth',
...
def build_regnet(cfg):
    # fmt: off
    pretrain      = cfg.MODEL.BACKBONE.PRETRAIN
    pretrain_path = cfg.MODEL.BACKBONE.PRETRAIN_PATH
    last_stride   = cfg.MODEL.BACKBONE.LAST_STRIDE
    #bn_norm       = cfg.MODEL.BN_TYPE
    depth         = cfg.MODEL.BACKBONE.STR_DEPTH
    # fmt: on

    cfg_files = {
        '200x': 'modeling/backbone/regnet/regnetx/RegNetX-200MF_dds_8gpu.yaml',
        '200y': 'modeling/backbone/regnet/regnety/RegNetY-200MF_dds_8gpu.yaml',
        '400x': 'modeling/backbone/regnet/regnetx/RegNetX-400MF_dds_8gpu.yaml',
        '400y': 'modeling/backbone/regnet/regnety/RegNetY-400MF_dds_8gpu.yaml',
        '800x': 'modeling/backbone/regnet/regnetx/RegNetX-800MF_dds_8gpu.yaml',
        '800y': 'modeling/backbone/regnet/regnety/RegNetY-800MF_dds_8gpu.yaml',
        '1600x': 'modeling/backbone/regnet/regnetx/RegNetX-1.6GF_dds_8gpu.yaml',
        '1600y': 'modeling/backbone/regnet/regnety/RegNetY-1.6GF_dds_8gpu.yaml',
        '3200x': 'modeling/backbone/regnet/regnetx/RegNetX-3.2GF_dds_8gpu.yaml',
        '3200y': 'modeling/backbone/regnet/regnety/RegNetY-3.2GF_dds_8gpu.yaml',
        '4000x': 'modeling/backbone/regnet/regnety/RegNetX-4.0GF_dds_8gpu.yaml',
        '4000y': 'modeling/backbone/regnet/regnety/RegNetY-4.0GF_dds_8gpu.yaml',
        '6400x': 'modeling/backbone/regnet/regnetx/RegNetX-6.4GF_dds_8gpu.yaml',
        '6400y': 'modeling/backbone/regnet/regnety/RegNetY-6.4GF_dds_8gpu.yaml',
    }[depth]

    regnet_cfg.merge_from_file(cfg_files)
    model = RegNet(last_stride, cfg)
